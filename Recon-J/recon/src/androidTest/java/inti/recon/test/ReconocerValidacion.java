...
public class ReconocerValidacion extends
		ActivityInstrumentationTestCase2<ReconActivity> {
	BillSearch bs;
	...
	public void testReconocerdosp_1() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.dosp_1), srcRGBA,
		...
		Mat rgba = new Mat();
		org.opencv.core.Size dzise = new org.opencv.core.Size(
				ReconActivity.Ancho, ReconActivity.Alto);
		Imgproc.resize(srcRGBA, rgba, dzise);
		mainActivity.Escena_actual = new Billete(getInstrumentation()
				.getContext(), rgba, rgba);

		// assert statements
		assertEquals(
				"0 ",
				bs.search(mainActivity.Escena_actual,
						mainActivity.getBilletes()));
	}
	...
	public void testReconocerdosp_10() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.dosp_10), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerdosp_20() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.dosp_20), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerdosp_30() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.dosp_30), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerdosp_40() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.dosp_40), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerdosp_50() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.dosp_50), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerdosp_60() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.dosp_60), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerdosp_70() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.dosp_70), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerdosp_80() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.dosp_80), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerdosp_90() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.dosp_90), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerdosp_100() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.dosp_100), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerdospd_1() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.dospd_1), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerdospd_10() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.dospd_10), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerdospd_20() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.dospd_20), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerdospd_30() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.dospd_30), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerdospd_40() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.dospd_40), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerdospd_50() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.dospd_50), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerdospd_60() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.dospd_60), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerdospd_70() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.dospd_70), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerdospd_80() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.dospd_80), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerdospd_90() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.dospd_90), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerdospd_100() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.dospd_100), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercincop_1() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cincop_1), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercincop_10() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cincop_10), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercincop_20() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cincop_20), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercincop_30() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cincop_30), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercincop_40() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cincop_40), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercincop_50() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cincop_50), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercincop_60() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cincop_60), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercincop_70() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cincop_70), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercincop_80() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cincop_80), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
			e.printStackTrace();
		}
	...
	public void testReconocercincop_90() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cincop_90), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercincop_100() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cincop_100), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercincopd_1() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cincopd_1), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercincopd_10() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cincopd_10), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercincopd_20() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cincopd_20), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercincopd_30() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cincopd_30), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercincopd_40() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cincopd_40), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercincopd_50() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cincopd_50), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercincopd_60() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cincopd_60), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercincopd_70() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cincopd_70), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercincopd_80() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cincopd_80), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercincopd_90() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cincopd_90), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercincopd_100() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cincopd_100), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerdiezp_1() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.diezp_1), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerdiezp_10() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.diezp_10), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerdiezp_20() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.diezp_20), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerdiezp_30() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.diezp_30), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerdiezp_40() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.diezp_40), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerdiezp_50() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.diezp_50), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerdiezp_60() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.diezp_60), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerdiezp_70() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.diezp_70), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerdiezp_80() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.diezp_80), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerdiezp_90() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.diezp_90), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerdiezp_100() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.diezp_100), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerdiezpd_1() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.diezpd_1), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerdiezpd_10() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.diezpd_10), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerdiezpd_20() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.diezpd_20), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerdiezpd_30() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.diezpd_30), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerdiezpd_40() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.diezpd_40), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerdiezpd_50() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.diezpd_50), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerdiezpd_60() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.diezpd_60), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerdiezpd_70() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.diezpd_70), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerdiezpd_80() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.diezpd_80), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerdiezpd_90() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.diezpd_90), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerdiezpd_100() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.diezpd_100), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerveintep_1() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.veintep_1), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerveintep_10() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.veintep_10), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerveintep_20() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.veintep_20), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerveintep_30() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.veintep_30), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerveintep_40() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.veintep_40), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerveintep_50() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.veintep_50), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerveintep_60() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.veintep_60), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerveintep_70() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.veintep_70), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerveintep_80() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.veintep_80), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerveintep_90() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.veintep_90), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerveintep_100() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.veintep_100), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerveintepd_1() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.veintepd_1), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerveintepd_10() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.veintepd_10), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerveintepd_20() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.veintepd_20), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerveintepd_30() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.veintepd_30), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerveintepd_40() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.veintepd_40), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerveintepd_50() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.veintepd_50), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerveintepd_60() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.veintepd_60), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerveintepd_70() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.veintepd_70), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerveintepd_80() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.veintepd_80), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerveintepd_90() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.veintepd_90), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerveintepd_100() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.veintepd_100), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercincuentap_1() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cincuentap_1), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercincuentap_10() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cincuentap_10), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercincuentap_20() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cincuentap_20), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercincuentap_30() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cincuentap_30), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercincuentap_40() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cincuentap_40), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercincuentap_50() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cincuentap_50), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercincuentap_60() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cincuentap_60), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercincuentap_70() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cincuentap_70), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercincuentap_80() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cincuentap_80), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercincuentap_90() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cincuentap_90), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercincuentap_100() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cincuentap_100), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercincuentapd_1() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cincuentapd_1), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercincuentapd_10() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cincuentapd_10), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercincuentapd_20() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cincuentapd_20), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercincuentapd_30() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cincuentapd_30), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercincuentapd_40() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cincuentapd_40), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercincuentapd_50() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cincuentapd_50), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercincuentapd_60() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cincuentapd_60), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercincuentapd_70() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cincuentapd_70), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercincuentapd_80() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cincuentapd_80), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercincuentapd_90() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cincuentapd_90), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercincuentapd_100() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cincuentapd_100), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercienp_1() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cienp_1), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercienp_10() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cienp_10), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercienp_20() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cienp_20), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercienp_30() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cienp_30), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercienp_40() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cienp_40), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercienp_50() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cienp_50), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercienp_60() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cienp_60), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercienp_70() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cienp_70), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercienp_80() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cienp_80), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercienp_90() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cienp_90), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercienp_100() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cienp_100), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercienpd_1() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cienpd_1), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercienpd_10() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cienpd_10), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercienpd_20() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cienpd_20), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercienpd_30() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cienpd_30), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercienpd_40() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cienpd_40), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercienpd_50() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cienpd_50), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercienpd_60() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cienpd_60), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercienpd_70() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cienpd_70), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercienpd_80() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cienpd_80), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercienpd_90() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cienpd_90), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocercienpd_100() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.cienpd_100), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerquinientosp_1() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.quinientosp_1), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerquinientosp_2() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.quinientosp_2), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerquinientosp_3() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.quinientosp_3), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerquinientosp_4() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.quinientosp_4), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerquinientosp_5() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.quinientosp_5), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerquinientosp_6() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.quinientosp_6), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerquinientosp_7() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.quinientosp_7), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerquinientosp_8() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.quinientosp_8), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerquinientosp_9() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.quinientosp_9), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerquinientosp_10() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.quinientosp_10), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerquinientosp_11() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.quinientosp_11), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerquinientospd_1() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.quinientospd_1), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerquinientospd_2() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.quinientospd_2), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerquinientospd_3() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.quinientospd_3), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerquinientospd_4() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.quinientospd_4), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerquinientospd_5() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.quinientospd_5), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerquinientospd_6() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.quinientospd_6), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerquinientospd_7() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.quinientospd_7), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerquinientospd_8() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.quinientospd_8), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerquinientospd_9() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.quinientospd_9), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerquinientospd_10() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.quinientospd_10), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
	...
	public void testReconocerquinientospd_11() {
		...
		try {
			Imgproc.cvtColor(Utils.loadResource(getInstrumentation()
					.getContext(), R.raw.quinientospd_11), srcRGBA,
					Imgproc.COLOR_BGR2GRAY);
		} catch (IOException e) {
