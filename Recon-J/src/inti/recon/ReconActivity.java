...
public class ReconActivity extends Activity implements CvCameraViewListener2,
		OnTouchListener {
	...
	private int[] ID_Templates = { R.raw.dosp, R.raw.dospd, R.raw.cincop,
			R.raw.cincopd, R.raw.diezp, R.raw.diezpd, R.raw.veintep,
			R.raw.veintepd, R.raw.cincuentap, R.raw.cincuentapd,
			R.raw.cincuentamalp, R.raw.cincuentamalpd, R.raw.cienp,
			R.raw.cienpd, R.raw.cienevp, R.raw.cienevpd, R.raw.quinientosp,
			R.raw.quinientospd, R.raw.cinconp, R.raw.cinconpd, R.raw.dieznp,
			R.raw.dieznpd };
	...
	private void llenar_lista_billetes() {
		for (int i = 0; i < ID_Templates.length; i = i + 2) {
			try {
				...
				Imgproc.cvtColor(
						Utils.loadResource(ReconActivity.this, ID_Templates[i]),
						srcRGBA, Imgproc.COLOR_BGR2GRAY);
				srcRGBA2 = new Mat(); // RGBA format
				Imgproc.cvtColor(Utils.loadResource(ReconActivity.this,
						ID_Templates[i + 1]), srcRGBA2, Imgproc.COLOR_BGR2GRAY);
	...
	public Mat onCameraFrame(CvCameraViewFrame inputFrame) {
		...
		if (bienvenida) {
			t1.speak(
					"Bienvenido a Recon. Toque la pantalla para comenzar el reconocimiento.",
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		while (veloItr.hasNext()) {
			...
			mVelocidadMenuItems[idx] = mVelocidadMenu.add(1, idx, Menu.NONE,
					element);
			idx++;
		}
		...
		while (effectItr.hasNext()) {
			...
			mEffectMenuItems[idx] = mColorEffectsMenu.add(2, idx, Menu.NONE,
					element);
			idx++;
		}
